class RouteConstant {
  ...
  static const investorRegisterStep1Route = '/investor/register/step-1';
  static const investorRegisterStep2Route = '/investor/register/step-2';
  static const investorRegisterStep3Route = '/investor/register/step-3';

  // Startup auth
  static const startupLoginRoute = '/startup/login';
  static const startupCompleteProfileRoute = '/startup/complete-profile';
  static const startupRegisterStep1Route = '/startup/register/step-1';
  static const startupRegisterStep2Route = '/startup/register/step-2';
