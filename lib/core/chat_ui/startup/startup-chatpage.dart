...
class StartupChatScreen extends StatefulWidget {
  const StartupChatScreen({super.key});

  @override
  State<StartupChatScreen> createState() => _StartupChatScreenState();
}

class _StartupChatScreenState extends State<StartupChatScreen> {
